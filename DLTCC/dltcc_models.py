...
class Dltcc(object):
    ...
    def build(self, inputs):
        ...
        with tf.name_scope("conv1"):
            self.conv1 = conv_layer(input=self.x_reshape, input_channels=1, filter_size=7, output_channels=4, use_pooling=True)

        with tf.name_scope("conv2"):
            self.conv2 = conv_layer(input=self.conv1, input_channels=4, filter_size=5, output_channels=8, use_pooling=True)
            # Conv 3
        ...
        #     self.conv4 = conv_layer(input=self.conv3, input_channels=16, filter_size=3, output_channels=32, use_pooling=True)
